About apache-airflow-providers-fab-feedstock
============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-fab-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-fab-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-fab
# for installing globally
pixi global install apache-airflow-providers-fab
```
...
It is possible to list all of the versions of `apache-airflow-providers-fab` available on your platform:
...
```
pixi search apache-airflow-providers-fab --channel conda-forge
```
